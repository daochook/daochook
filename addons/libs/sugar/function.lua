...
----------------------------------------------------------------------------------------------------
--
-- Functional Helpers (Coroutine Forwards via daochook Tasks)
--
----------------------------------------------------------------------------------------------------
...
function_mt.repeating = function (self, delay, repeats, repeat_delay, ...)
    hook.tasks.loop(delay, repeats, repeat_delay, self, ...);
end
...
function_mt.repeatingf = function (self, delay, repeats, repeat_delay, ...)
    hook.tasks.loopf(delay, repeats, repeat_delay, self, ...);
end
